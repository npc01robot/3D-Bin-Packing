...
from ability.py3dbp import Bin, ItemSet
from ability.py3dbp.figure.packer import Packer
from ability.py3dbp.utils.constants import DEFAULT_NUMBER_OF_DECIMALS
from ability.py3dbp.utils.merge_item import MergeItemTool
...
class Solution:
    ...
    def find_box(
        ...
        if painting:
            from ability.py3dbp.utils.painter import Painter
