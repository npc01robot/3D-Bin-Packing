...
class Node:
    def __init__(self, player: int, state: str, prev_node: Optional[Node] = None,
                 transposition_table: Optional[Dict[tuple, str]] = None):
        ...
        if action not in self.children:
            if self.transposition_table is not None:
                ...
                if key in self.transposition_table:
                    ...
                    self.children[action] = self.transposition_table[key] = Node(next_player, next_state,
...
class MCTS:
    def __init__(self, game: Game, allow_transpositions: bool = True, training: bool = True):
        ...
        self.root = Node(self.game.current_player(), str(self.game.get_state()),
                         transposition_table=self.transposition_table)
        if self.transposition_table is not None:
