...
class Item:
    ...
    def __init__(
        ...
        self.x_area = self.width * self.depth  # x轴方向的面积
        self.y_area = self.height * self.depth  # y轴方向的面积
        self.z_area = self.width * self.height  # z轴方向的面积
        self.max_area = self.getMaxArea()  # 最大的面积
